      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {agents.map((agent, index) => (
            ...
            >
              <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${agent.color} p-4 mb-4 group-hover:scale-110 transition-transform`}>
              ...
              <div className="inline-block bg-cyan-500/20 px-3 py-1 rounded-full text-sm text-cyan-300">
                {agent.stats}
              </div>
            </motion.div>
          ))}
...
<div class="progress-nav">
  <a href="03-backend.html">← Back: Backend</a>
  <a href="05-testing.html">Next: Testing Strategy →</a>
</div>
